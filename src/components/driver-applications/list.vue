<template xmlns:router-link="">
  <div class="stageone">
    ...
    <el-table :data="paginated_partners" v-loading.body="loading" @row-click="startVerification" border stripe nnnn :default-sort="{ prop: 'date_created', order: 'descending' }" width="100">
