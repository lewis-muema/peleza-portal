      ...
      <div class="applicant-details-holder">
        <el-card class="applicant-details__profile__personal-details">
          <el-button
            ...
            @click="handleBack"
          ><i class="fa fa-arrow-left el-icon-right back-icon"></i> Back to List</el-button>
          ...
          <div
            class="applicant-details__profile_content"
            v-if="applicant_details.application_type !== 'Owner'"
          >
          ...
          <el-button
            type="primary status-button"
            :class="getApplicantStatus(category)"
          > {{ getApplicantStatus(category) }}</el-button>
          <el-card
            header="Submit Applicant"
            class="applicant-details__submit-review"
            v-if="category === 'applications' || category === 'driver-applications' && validSubmit"
          >
            <el-form>
              <el-form-item>
                <el-select
          ...
          <el-card
            header="Activity"
            class="applicant-details__profile__personal-details activity-logs"
        ...
        >
          <div class="applicant--details-wrap">
            ...
            >
              ...
              <el-form
                :model="verification_details.identity_check"
                v-show="!identityReview"
              >
                ...
                <el-form-item label="Gender">
                  <el-select
                    v-model="verification_details.identity_check.gender"
                    auto-complete="off"
                  >
              ...
              <div
                class="review_wrap"
                v-show="verification_details.identity_check.review_status"
              >
                <div class="el-row">
                  ...
                  <div class="el-col-lg-8 review-image">
                    <div
                      class="review-edit"
                      @click="handleReviewEdit('identity_check')"
                    >Edit</div>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              <el-form
                :model="verification_details.driving_license_check"
                v-if="!drivingReview"
              >
                <el-form-item label="Name of Applicant">
                  <el-input
              ...
              >
                ...
                <div class="el-col-lg-8 review-image">
                  <div
                    class="review-edit"
                    @click="handleReviewEdit('driving_license_check')"
                  >Edit</div>
                </div>
              </div>
              <el-form class="applicant--incosistency-wrap">
          ...
          <div
            class="applicant--details-wrap"
            v-show="applicant_details.application_type !== 'Owner' && applicant_details.vendor_type === '1'"
          >
            <el-collapse-item
              class="verification-wrap"
              name="6"
            >
              ...
              <el-form
                :model="verification_details.good_conduct_verification"
                v-show="!goodConductReview"
              >
                <el-form-item label="Reference Number">
                  <el-input
                    v-model="verification_details.good_conduct.reference_number"
                    auto-complete="off"
                  ></el-input>
                </el-form-item>
                <el-form-item label="Date Issued">
                  <el-date-picker
                    v-model="verification_details.good_conduct.date_of_issue"
                    auto-complete="off"
                    type="date"
                    popper-class="date-popup"
                ...
                <el-form-item label="Number of offences">
                  <br />
                  <el-input-number
                    v-model="verification_details.good_conduct.number_of_offences"
                    auto-complete="off"
                    :min="0"
                  ></el-input-number>
                </el-form-item>
              ...
              <div class="el-col-lg-7 review-image">
                <div
                  class="review-edit"
                  @click="handleReviewEdit('good_conduct')"
                  v-show="goodConductReview"
                >Edit</div>
              </div>
              <el-form class="applicant--incosistency-wrap">
                <el-form-item>
                  <el-checkbox
                    v-model="verification_details.good_conduct.inconsistency"
          ...
          >
            ...
            >
              ...
              <el-form
                :model="verification_details.kra_pin_verification"
                v-show="!kraReview"
              >
                <el-form-item label="Validity">
                  <el-input
