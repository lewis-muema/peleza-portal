  ...
  <div class="login">
    ...
    <el-form :model="login_form" ref="login_form" @submit="login" :rules="rules">
      <el-form-item label="Email" prop="email">
        <el-input placeholder="e.g. sendyer@sendy.co.ke" v-model="login_form.email" type="email" ref="emailInputField"></el-input>
      </el-form-item>
      <el-form-item label="Password" prop="password">
        <el-input placeholder="Your Password" v-model="login_form.password" type="password" ref="passwordInputField"></el-input>
      </el-form-item>
      <el-button type="primary" class="mt" @click="login" v-loading.fullscreen.lock="logging_in">Login</el-button>
    </el-form>
  </div>
</template>
...
export default {
  ...
  created() {
    if (Object.prototype.hasOwnProperty.call(localStorage, 'refresh_token')) {
