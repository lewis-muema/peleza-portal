...
describe ('login-test', () => {
  ...
  beforeEach (() => {
    ...
    global.BASE_URL =
      'https://ridertest.sendyit.com/admin_partner_api/v5/admin/';
    ...
    moxios.wait (() => {
      ...
      request
        ...
        .then (() => {
          ...
          expect (JSON.parse (localStorage.user).email).equal (
            wrapper.vm.login_form.email
          );
          done ();
        });
    });
